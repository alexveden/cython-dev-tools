...
from Cython.Utils import find_root_package_dir, is_package_dir, open_source_file
...
class Plugin(CoveragePlugin):
    ...
    #         raise IsADirectoryError(f'Expected to be a directory')
    #     all_pyx = glob.glob(os.path.join(src_dir, '**', '*.pyx'), recursive=True)
    #
    #     return all_pyx
